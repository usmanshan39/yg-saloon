    ...
    <header class="about-us">
        ...
        <div class="about-banner">
            <div class="col-md-8 m-auto">
                <p class="small-heading1 text-white">HOME / BLOG DETAILS</p>
                <h1 class="main-heading42">BLOG NAME</h1>
            </div>
        </div>
    </header>
    ...
    <section class="blogs-sec1 m-sec-top">
        <div class="container my-5">
            ...
            <?php echo $resultData['blog_desc'] ?>
              ...
              <h1 class="text-center font-weight-bold text-dark">Revenge of the Never Trumpers
          </h1>
              <div>
                  <small class="text-dark">
                    Written by <a href="#" class="text-primary">Ahmad Sultani</a>
                </small>
              </div>  
              </div>
